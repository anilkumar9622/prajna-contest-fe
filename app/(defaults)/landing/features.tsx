  ...
  const courses = [
    {
      ...
      img: "/assets/landing/featured-courses/1.png", // put your images in /public/courses/
      bg: "bg-green-200",
    },
    {
      level: "Intermediate",
      ...
      img: "/assets/landing/featured-courses/1.png",
      bg: "bg-blue-200",
    },
    {
      level: "Advanced",
    ...
    <section className="py-16">
      <div className="container mx-auto px-6">
        ...
        <h2 className="text-4xl font-bold mb-2">
          Featured <span className="text-green-600 italic">Courses</span>
        </h2>
          ...
          {courses.map((course, index) => (
            ...
            >
              ...
              <button className="absolute top-4 left-4  shadow">
                <img src="/assets/landing/featured-courses/2.png" />
              </button>
